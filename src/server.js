...
export default {
  ...
  async fetch(request, env) {
    if (request.method === 'POST') {
      ...
      console.log(`sig: ${signature}; ts: ${timestamp}; pubkey: ${env.DISCORD_APPLICATION_PUBLIC_KEY}`);
